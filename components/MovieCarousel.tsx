  ...
  return (
    <div className="space-y-2 py-4">
      ...
      <div className="relative group">
        <div ref={carouselRef} className="flex gap-2 overflow-x-auto scrollbar-hide snap-x pb-4">
          {movies.map((movie, index) => (
            <div key={movie.id} className="flex-shrink-0 w-[150px] md:w-[180px] snap-start">
